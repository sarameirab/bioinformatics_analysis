...
# ...rest of your project_code remains the same...

# Download and read file using gdown
path = download_google_drive_url(PROTEOMICS_CORRELATION_URL)
depmap_gdscs_merged_ttest_path = download_google_drive_url(DEPMAP_GDSC1_TTEST_ALL_MERGED)
