...
generate_boxplot <- function(gene_name, drug_name, data_path) {
  ...
  merged_data <- merged_data %>%
    mutate(LOF_Status = ifelse(LOF > 0, "LOF", "No LOF"))
  ...
  # Perform t-test
  t_test <- t.test(Sensitivity ~ LOF_Status, data = merged_data)
...
drug_name <- "ARV-825 (BRD:BRD-A00047421-001-01-7)" # Replace with desired drug name
