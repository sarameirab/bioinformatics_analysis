...
df_ic50 <- as.data.frame(gdsc1_drug_sensitivity_for_proteomics) %>% filter(rownames(df_ic50) == 1073)
...
```{r}
calculate_correlation_for_all_drugs(gdsc1_drug_sensitivity_for_proteomics, proteomics_z_score_with_depmap_id, 50)
```
