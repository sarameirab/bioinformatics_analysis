...
from urls import download_url, PROTEOMICS_MATRIX_AVERAGE_ZSCORE, DEPMAP_MODEL_MAPPING

# Read data
proteomics_z_score_path = download_url(PROTEOMICS_MATRIX_AVERAGE_ZSCORE)
proteomics_z_score = pd.read_csv(proteomics_z_score_path,
                                sep='\t')

model_mapping_path = download_url(DEPMAP_MODEL_MAPPING)
